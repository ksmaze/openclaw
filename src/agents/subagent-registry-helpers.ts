...
/**
 * Completion-message flows get a higher retry budget because they may need
 * to wait for the main agent to become available or for descendant runs to
 * settle before delivery can succeed.
 */
export const MAX_ANNOUNCE_COMPLETION_RETRY_COUNT = 8;
